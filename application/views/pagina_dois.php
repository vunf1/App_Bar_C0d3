...
<nav class="navbar navbar-toggleable-md navbar-light bg-faded navbar-fixed">
  ...
  <a class="navbar-brand" href="">Galaxia Bar</a>
...
<div class="max-width">
             ...
             <a class="btn btn-lg  max-width" >
         <i class="glyphicon glyphicon-tasks "></i><span>Daily Tasks<br><small>Lorem ipsum dolor</small></span></a> 
             <a class="btn btn-lg max-width" >
         <i class="glyphicon glyphicon-tasks "></i><span>Daily Tasks<br><small>Lorem ipsum dolor</small></span></a> 
             <a class="btn btn-lg btn-danger max-width" >
         <i class="glyphicon glyphicon-tasks "></i><span>Daily Tasks<br><small>Lorem ipsum dolor</small></span></a> 
        ...
        <ul class="event-list">
          ...
          <li>
            ...
            <div class="info">
              ...
              <p class="desc">Aqui vai estar todo o tipo de Comida</p>
            </div>
          </li>
          ...
          <li>
            ...
            <div class="info">
              ...
              <p class="desc">Aqui vai estar todo o tipo de Jogos da Casa</p>
            </div>
          </li>
